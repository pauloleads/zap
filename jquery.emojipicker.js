;(function($) {
  ...
  var categories = [
    { name: 'people', label: 'Emojis',emoji:'grinning' },
    { name: 'nature', label: 'Nature',emoji:'herb' },
    { name: 'food', label: 'Food',emoji:'apple' },
    { name: 'activity', label: 'Activities',emoji:'soccer' },
    { name: 'travel', label: 'Travel & Places',emoji:'car' },
    { name: 'object', label: 'Objects',emoji:'computer' },
    { name: 'symbol', label: 'Symbols',emoji:'heart' },
    { name: 'flag', label: 'Flags',emoji:'flag-co' }
  ];
  ...
  $.extend(EmojiPicker.prototype, {
    ...
    addPickerIcon: function() {
      ...
      if (this.settings.button) {
        ...
        this.$wrapper = this.$el
          .wrap("<div class='emojiPickerIconWrap emoji_"+$(this.$el).attr('id')+"'></div>")
          .parent();
    ...
    destroyPicker: function() {
      ...
      $('.emoji_'+$(this.$el).attr('id')+' .emojiPickerIcon').remove();
      $('.emoji_'+$(this.$el).attr('id')).removeClass('emojiPickerIconWrap');
  ...
  function getPickerHTML() {
    ...
    if (localStorageSupport) {
      nodes.push('<div class="tab active" data-tab="recent"><div class="emoji emoji-arrows_counterclockwise"></div></div>');
    }
